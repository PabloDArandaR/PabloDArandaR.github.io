...
const reading = {
  last: { author: "Murakami, Haruki", title: "Kafka en la orilla" },
  current: [
        ...
        <div style={bioColStyle}>
          ...
          <div className="reveal" style={{ transitionDelay: "0.2s" }}>
            <p style={bioTextStyle}>
              Originally from Zaragoza, a spanish mid-sized city, 1 hour away
              from the Pyrinees, I ended up studying Industrial Engineering at
              the University of Zaragoza, then crossing half of Europe to study
              as an exchange student and then pursue a Master's in Robotics at
              SDU in Odense — completed with an exchange semester at Hochschule
              München and a thesis at the Technische Universität München.
            </p>
          </div>
          ...
          <div
            className="reveal"
            style={{ ...interestsRowStyle, transitionDelay: "0.3s" }}
          >
            {/* Interests */}
            ...
            <div style={interestBlockStyle}>
              ...
              <div style={bookSectionStyle}>
                ...
                <p style={bookStyle}>
                  {reading.last.author}.{" "}
                  <em style={{ color: "var(--color-sub-dimm)" }}>
                    {reading.last.title}
                  </em>
                </p>
              </div>
...
const dotGridStyle = {
  ...
  inset: 0,
  backgroundImage:
    "radial-gradient(circle, rgba(93,138,168,0.18) 1px, transparent 1px)",
...
const photoStyle = {
  ...
  boxShadow:
    "0 8px 32px rgba(0,0,0,0.18), 0 0 0 1px rgba(var(--color-strong-rgb), 0.1)",
  display: "block",
};
